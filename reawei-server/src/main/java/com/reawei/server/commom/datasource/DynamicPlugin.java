...
public class DynamicPlugin implements Interceptor {
    ...
    private static final Map<String, DbType> CACHE_MAP = new ConcurrentHashMap<>();
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (!synchronizationActive) {
            ...
            DbType dynamicDataSourceGlobal = null;
            ...
            if ((dynamicDataSourceGlobal = CACHE_MAP.get(ms.getId())) == null) {
                ...
                if (ms.getSqlCommandType().equals(SqlCommandType.SELECT)) {
                    ...
                    if (ms.getId().contains(SelectKeyGenerator.SELECT_KEY_SUFFIX)) {
                        dynamicDataSourceGlobal = DbType.WRITE;
                    } else {
                        ...
                        if (sql.matches(REGEX)) {
                            ...
                            dynamicDataSourceGlobal = DbType.READ;
                        }
                    }
                } else {
                    dynamicDataSourceGlobal = DbType.WRITE;
            ...
            DbContextHolder.putDataSource(dynamicDataSourceGlobal);
        }
